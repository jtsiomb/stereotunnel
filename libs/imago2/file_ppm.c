...
static int readppm(struct img_pixmap *img, struct img_io *io);
static int writeppm(struct img_pixmap *img, struct img_io *io);

int img_register_ppm(void)
{
	static struct ftype_module mod = {".ppm", check, readppm, writeppm};
