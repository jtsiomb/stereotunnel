...
static int readjpeg(struct img_pixmap *img, struct img_io *io);
static int writejpeg(struct img_pixmap *img, struct img_io *io);
...
{
	static struct ftype_module mod = {".jpg", check, readjpeg, writejpeg};
